...
def mostUsers():
    ...
    outputFile = open('C:/Users/VenksUV/Desktop/6112 - SSDI/TwitterTextAnalysis/MostUsers.txt', 'w', encoding = "utf-8")
...
def mostUsersPerHour():
    ...
    outputFile = open('C:/Users/VenksUV/Desktop/6112 - SSDI/TwitterTextAnalysis/MostUsersPerHour.txt', 'w', encoding = 'utf-8')
...
def maxFollowers():
    ...
    l = sorted(l.items(), key = operator.itemgetter(1), reverse = True)
    outputFile = open('C:/Users/VenksUV/Desktop/6112 - SSDI/TwitterTextAnalysis/MaxFollowers.txt', 'w', encoding = "utf-8")
...
def maxRetweet():
    ...
    outputFile = open('C:/Users/VenksUV/Desktop/6112 - SSDI/TwitterTextAnalysis/MaxRetweets.txt', 'w', encoding = "utf-8")
    l = sorted(l.items(), key = operator.itemgetter(1), reverse = True)
